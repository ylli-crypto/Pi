...
function buildProviderButtons(
	available: { openai: boolean; brave: boolean; tavily: boolean; perplexity: boolean; exa: boolean; gemini: boolean },
	selected: string,
...
export function generateCuratorPage(
	...
	sessionToken: string,
	timeout: number,
	availableProviders: { openai: boolean; brave: boolean; tavily: boolean; perplexity: boolean; exa: boolean; gemini: boolean },
...
const SCRIPT = `(function() {
  ...
  var providers = ["openai", "exa", "brave", "tavily", "perplexity", "gemini"];
