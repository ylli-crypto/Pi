...
type ProfileAgentName = "scout" | "reviewer";
...
export interface ProviderModelCatalogModel {
	...
	derived: {
		...
		recommendedAgents: ProfileAgentName[];
...
function agentsForRoleTier(roleTier: RecommendedRoleTier): ProfileAgentName[] {
	return roleTier === "strong" ? ["reviewer"] : ["scout"];
}
